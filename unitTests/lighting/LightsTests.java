...
public class LightsTests {
    ...
    public void sphereMultipleLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new DirectionalLight(new Color(1000, 600, 0), new Vector(-1, -1, -0.5)));
        scene1.lights.add(new PointLight(new Color(500, 300, 0), new Point(100, 100, 50))
                .setKl(0.0005).setKq(0.0001));
        scene1.lights.add(new SpotLight(new Color(300, 150, 150), new Point(-100, -100, 50), new Vector(1, 1, -0.5))
                .setKl(0.0005).setKq(0.0002));

        camera1.setImageWriter(new ImageWriter("sphereMultipleLights", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void trianglesMultipleLights() {
        ...
        // Adding a strong directional light from the top-right
        scene2.lights.add(new DirectionalLight(new Color(400, 200, 200), new Vector(-1, -1, -0.5)));

        // Adding a point light from the bottom-left with a different color
        scene2.lights.add(new PointLight(new Color(800, 400, 400), new Point(-50, 50, -50))
                .setKl(0.0005).setKq(0.0001));

        // Adding a spot light from the top-left with a different color
        scene2.lights.add(new SpotLight(new Color(300, 600, 300), new Point(50, 50, -50), new Vector(-1, -1, 0.5))
                .setKl(0.0005).setKq(0.0002));

        // Adding another point light from the right with a different color
        scene2.lights.add(new PointLight(new Color(200, 200, 600), new Point(100, -50, -50))
                .setKl(0.0005).setKq(0.0001));
